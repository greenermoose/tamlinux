...
Each record names the tool and model used, the user direction that can be
published, the decisions made, and the related commit.

| Date | Topic | Tool and model | Record |
| :-- | :-- | :-- | :-- |
